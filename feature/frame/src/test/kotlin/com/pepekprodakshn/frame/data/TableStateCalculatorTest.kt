...
internal class TableStateCalculatorTest : FreeSpec(
    {
            ...
            "Scenario: break ended" - {
                ...
                "Given: TableStateCalculator" - {
                    ...
                    "When: second player break ended" - {
                        val actions = listOf(FrameActionsDTO.BreakEnded, FrameActionsDTO.BreakEnded)
                        val state = calculator.calculateState(actions)
            ...
            "Scenario: foul" - {
                ...
                "Given: TableStateCalculator" - {
                    ...
                    "When: player foul with miss" - {
                        val actions = listOf(FrameActionsDTO.Fouled(testFoul.copy(isMiss = true)))
                        val state = calculator.calculateState(actions)
